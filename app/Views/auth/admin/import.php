    ...
    <div class="col-md-12">
        ...
        <section class="showcase">
            <div class="container">
                ...
                <div class="row padall border-bottom">
                    <div class="col-lg-12">
                        <div class="float-right">
                            <a href="<?php print site_url();?>uploads/sample-gaji-xlsx.xlsx" class="btn btn-info btn-sm"><i
                                    class="fa fa-file-excel"></i> Sample .XLSX</a>
                            <a href="<?php print site_url();?>uploads/sample-gaji-xls.xls" class="btn btn-info btn-sm"><i
                ...
                <form action="<?php print site_url();?>admin/phpspreadsheet/upload" class="excel-upl" id="excel-upl"
