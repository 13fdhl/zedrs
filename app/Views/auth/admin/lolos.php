<div class="row">
	...
	<a href="<?=site_url('admin/phpspreadsheet_pelamar')?>" class="btn btn-info"
										style="margin-bottom: 2px">Upload List Pelamar</a> 
	<button type="button" class="btn btn-success" style="font-size:10pt" data-toggle="modal" data-target="#modalAdd"> Tambah Pegawai
		</button>
				...
				<div class="table-responsive">
				  ...
				  ?>
							<tr>
								...
								<td><?=$r->phone?></td>
								<td>
								<a href="<?=site_url('admin/lolos/tolak/'.$r->id)?>" class="fa fa-times-circle fa-2x" style="color:red"></a></td>
								<td>
...
<div id="modalAdd" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<form action="<?=site_url()?>admin/lolos/add_karyawan" method="post">
				<div class="modal-body">
					<div class="form-group row">
