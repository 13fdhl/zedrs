            ...
            <thead>
              ...
              ?>
                <tr>
                  ...
                  <td style="text-align: center;"><a href="<?=site_url('admin/approval/setuju/'.$r->a_id)?>" class="fa fa-check-circle fa-2x" style="color:green"></a>
                                                  <a href="<?=site_url('admin/approval/tolak/'.$r->a_id)?>" class="fa fa-times-circle fa-2x" style="color:red"></a></td>
                </tr>
              <?php endforeach; ?>
              </tbody>
