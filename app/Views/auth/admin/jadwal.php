				...
				<div class="table-responsive">
					...
					?>
							<tr>
								...
								<td><?=($r->status_pegawai=='1')?'Aktif':'Tidak Aktif'?></td>
								<td>
									<!-- <a href="<?=site_url('admin/karyawan/detail/'.$r->id)?>" class="btn btn-primary"
										style="margin-bottom: 2px">Lihat</a> <br> -->
									<?php if($this->ion_auth->is_admin()): ?>
									<a href="<?=site_url('admin/karyawan/delete_karyawan/'.$r->id)?>"
										class="btn btn-info" style="margin-bottom: 2px">Atur Jadwal</a> <br>
