        ...
        <div class="card overflow-hidden">
          <div class="row no-gutters row-bordered row-border-light">
            ...
            <div class="col-md-3 pt-0">
              <div class="list-group flex" id="list-tab" role="tablist">
                ...
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#pasangan" role="tab">
                    <i class="fa fa-user text-lightest"></i>&nbsp; Data Pasangan</a>
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#anak" role="tab">
                    <i class="fa fa-user text-lightest"></i>&nbsp; Data Anak</a>
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#pendidikan" role="tab">
                    <i class="fa fa-user text-lightest"></i>&nbsp; Riwayat Pendidikan</a>
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#jabatan" role="tab">
                    <i class="fa fa-user text-lightest"></i>&nbsp; Riwayat Jabatan</a>
                                    
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#photo" role="tab"> <i
                    class="fa fa-photo text-lightest"></i>&nbsp; Foto</a>
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#dokumen"> <i
                    class="fa fa-file text-lightest"></i>&nbsp; Dokumen</a>
                <a class="list-group-item list-group-item-action" data-toggle="list" href="#password"> <i
                    class="fa fa-key text-lightest"></i> &nbsp; Ganti Password</a>
              </div>
            </div>
                        ...
                        <div class="panel-body">
                          <form action="<?=site_url()?>admin/karyawan/update_profile/<?=$profile->id?>" method="post"
                            ...
                            <!--    <table class="table1">-->
	                           <!--     <tbody>-->
	                           <!--     <tr>-->
	                           <!--     	<th colspan="6"><h3>DATA SUAMI/ISTRI</h3></th>-->
	                           <!--     </tr>-->
	                           <!--     <tr>-->
                            ...
                            <!--    <table class="table1">-->
	                           <!--     <tbody>-->
	                           <!--     <tr>-->
	                           <!--     	<th colspan="5"><h3>DATA ANAK</h3></th>-->
	                           <!--     </tr>-->
                                ...
                                <table class="table1">
	                                ...
	                                <tr>
	                                	...
	                                	<tr>
	                                		...
	                                		<td><input type="text" name="pendidikanpasangan" class="form-control title" required autocomplete="off" value="<?=$profile->pendidikan_pasangan??''?>"></td>
	                                		<td>
	                                		    <button type="button" class="btn-plus" onclick="addField(this);">
