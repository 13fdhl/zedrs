				...
				<div class="table-responsive">
				  ...
				  ?>
							<tr>
								...
								<td><?=$r->jabatan?></td>
								<td><?=$r->phone?></td>
								<td><a href="<?=site_url('admin/lanjut/setuju/'.$r->id)?>" class="fa fa-check-circle fa-2x" style="color:green"></a>
								<a href="<?=site_url('admin/lanjut/tolak/'.$r->id)?>" class="fa fa-times-circle fa-2x" style="color:red"></a></td>
								<td>
