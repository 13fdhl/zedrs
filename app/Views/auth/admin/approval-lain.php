          ...
          <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
            <thead>
              ...
              ?>
                ...
                <td></td>
                <?php if($r->status=="0") { ?>
                  <td style="text-align: center;"><a href="<?=site_url('admin/approval_lain/setuju/'.$r->a_id)?>" class="fa fa-check-circle fa-2x" style="color:green"></a>
                                                  <a href="<?=site_url('admin/approval_lain/tolak/'.$r->a_id)?>" class="fa fa-times-circle fa-2x" style="color:red"></a></td>
                                                  <?php } ?>
                </tr>
              <?php endforeach; ?>
              </tbody>
